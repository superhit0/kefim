...
public class App 
{
    public static void main( String[] args )
    {
        ...
        try {
            ...
            obj.runAlgorithm(k,1,inputPath,outputPath,activateTransactionMerging,maximumTransactionCount,activateSubtreeUtilityPruning);
            obj.printStats();
